...
public class OnTrigger2dScriptLEVEL2 : MonoBehaviour
{
    public GameControllerLEVEL2 gameController;
    ...
    [SerializeField]
    private GameObject orangeExplosion;
    [SerializeField]
    private GameObject greenExplosion;
    [SerializeField]
    private GameObject purpleExplosion;
    ...
    void Start()
    {
        ...
        {
            { "Orange", orangeExplosion },
            { "Green", greenExplosion },
            { "Purple", purpleExplosion }
        };
    }

    void OnTriggerEnter2D(Collider2D collision)
    {
        // Get the PotionBehaviorLEVEL2 component from the collided object
        PotionBehaviorLEVEL2 potionBehavior = collision.GetComponent<PotionBehaviorLEVEL2>();
